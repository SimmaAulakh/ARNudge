...
//        }
	...
	private func loadModel() {
        ...
        for node in wrapperNode.childNodes{
            print("nodeName= \(String(describing: node.name))")
            for n in node.childNodes{
                print("nodeName= \(String(describing: n.name))")
            for key in n.animationKeys{
                print("animatedddd= \(key)")
            }
        }
    }
    ...
    func pause() {
        contentRootNode.isPaused = !contentRootNode.isPaused
        //resetState()
    }
